...
gdjs.GameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8290884);
}
}}
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GameCode.mapOfGDgdjs_46GameCode_46GDRockObjects2Objects, gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) / 2 - gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().get("rockWidth")) / 2, -(gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().get("rockWidth"))) - 250, "");
...
{
{gdjs.GameCode.conditionTrue_1 = gdjs.GameCode.condition1IsTrue_0;
gdjs.GameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8333772);
}
}}
if (gdjs.GameCode.condition1IsTrue_0.val) {
...
{
{gdjs.GameCode.conditionTrue_1 = gdjs.GameCode.condition0IsTrue_0;
gdjs.GameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8342756);
}
}if (gdjs.GameCode.condition0IsTrue_0.val) {
